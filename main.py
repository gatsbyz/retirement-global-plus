...
fileio.write_csv([retirement_years, years_to_retirement, savings, portfolio_type, total_stocks_bonds], "user_data.csv")
...
fileio.write_csv(retirement_cities, "retirement-cities.csv")
