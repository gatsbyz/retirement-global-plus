...
def get_applicant_info():
    ...
    initial_investment = questionary.text("How much capital would like to invest?").ask()
    yearly_income = questionary.text("What is your expected yearly income at the time of retirment?").ask()
    est_yearly_savings = questionary.text("What is your estimated yearly savings post retirement?").ask()

    yearly_income = int(yearly_income)
    initial_investment = int(initial_investment)
    est_yearly_savings = int(est_yearly_savings)

    return yearly_income, initial_investment, est_yearly_savings
